function runOutputCounter = importfile(filename)
%IMPORTFILE Import data from a text file
%  RUN0OUTPUTCOUNTER5 = IMPORTFILE(FILENAME) reads data from text file
%  FILENAME for the default selection.  Returns the numeric data.
%
%  RUN0OUTPUTCOUNTER5 = IMPORTFILE(FILE, DATALINES) reads data for the
%  specified row interval(s) of text file FILENAME. Specify DATALINES as
%  a positive scalar integer or a N-by-2 array of positive scalar
%  integers for dis-contiguous row intervals.
%
%  Example:
%  run0outputCounter5 = importfile("C:\Users\gchem\Geant4\XRayToF_Git\Parsing\Knee_Low_Res\outCoont\run_0outputCounter_5.csv", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 17-Jun-2021 15:13:59
...
% Import the data
runOutputCounter = readtable(filename, opts);

%% Convert to output type
runOutputCounter = table2array(runOutputCounter);
end